...
<form action="view_student.php" method="POST" name="submit">
	<div class="row">
   <div class="col"> 
...
<div class="col">
	...
	<div class="col">
		<div class="form-group input-group">
		<input name="submit" value="Show Student" type="submit" class="btn submit_green btn-success w-75 "text-white >
		</div>
	</div>
	</div>
</form>
